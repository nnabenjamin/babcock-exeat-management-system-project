    ...
    <div class="container" id="slice">
      <div class="row">
        <div class="col-md-4 offset-md-4 form-wrapper">
          <h3 class="text-center form-title">Student Login</h3>
          <form>
            <div class="form-group">
              <label>Matric number</label>
              <input id="login_matric_no" type="text" name="Matric number" required class="form-control form-control-lg">
            </div>
            <div class="form-group">
              <label>Password</label>
              <input id="login_password" type="password" name="password" required class="form-control form-control-lg">
            </div>
            <div class="form-group">
            ...
            <p>Don't have an account? <a href="../student/register.php">Signup</a></p>
          </form>
      </div>
    </div>
