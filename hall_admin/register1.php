    ...
    <div class="container" id="slice">
        <div class="row">
          <div class="col-md-4 offset-md-4 form-wrapper">
            <h3 class="text-center form-title">Admin Register</h3>
            <form>
            ...
            <p>Already have an account? <a href="../hall_admin/login.php">Login</a></p>
          </div>
        </div>
      </div>
      ...
      <script src="../JS/hall_admin/register.js"></script>
      <?php } ?>
</body>
</html>