    ...
    <section class="main">
      ...
      <section class="main-course">
        ...
        <div class="course-box">
          ...
          <div class="course">
            <?php
            $stmt = "SELECT * FROM `account_details` INNER JOIN `gate_pass_request` ON `account_details`.`id` = `gate_pass_request`.`user_id` WHERE approved = 'true'";
